...
struct Division: View {
    ...
    var rows: Int // each row shows three conference logos, amount of rows is amount of conferences divided by 3
            ...
            VStack(spacing: 20){
                ...
                if rows <= 0 {
                    ...
                    ForEach(0 ..< rows) { num in
                        ...
                        if (num == rows - 1 && conf.count % 3 == 1){
                            ConferencesRow(confs: [conf[num * 3]])
                        } else if (num == rows - 1 && conf.count % 3 == 2){
